...
import { AnimatedBeamSection } from "@/components/demos/animated-beam-section";
import BoxRevealDemo from "@/components/demos/box-reveal-section";
import { IconStarFilled } from "@tabler/icons-react";
import { GuaranteesSection } from "@/components/demos/guarantees-section";
   ...
   md:px-16
      ...
      <Element name="process">
        <main className="md:px-0 mx-6 md:mx-auto">
          <h1 className="text-3xl md:text-5xl md:text-center font-medium flex items-center gap-x-2 mx-auto justify-center">
            Our{" "}
            <span className="text-blue-500 flex gapx-x-1 items-center">
              {" "}
              <Image
        ...
        <main className="md:flex items-center justify-center space-y-6 md:space-y-0 md:gap-x-20 xl:w-4/5 2xl:w-[68%] mx-auto px-6 md:px-0">
          ...
          <div className="flex flex-col gap-y-5 md:w-1/2">
            <h1 className="text-lg md:text-2xl ">
              &quot;We&apos;ve been working with domain76 for over 2 years and
      ...
      <footer className="bg-[#fafafa] py-10  px-6 md:px-0 md:mx-auto border-t">
        ...
        <div className="flex md:justify-center gap-x-4 mt-10">
          © 2025 domain76. All Rights Reserved.
